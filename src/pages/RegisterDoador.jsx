...
export default function RegisterDoador() {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <img
        src={logo}
        alt="Logo"
        className="absolute top-6 left-6 w-32 z-10"
      />
      ...
      <div className="absolute top-1/2 left-[61%] transform -translate-y-1/2 bg-white/20 backdrop-blur-md rounded-2xl p-10 w-[350px] z-10 shadow-lg text-white">
        {!cadastroConcluido ? (
          <>
            <h1 className="text-2xl font-bold mb-6">Cadastro – Doador</h1>
            ...
            <div className="text-center mt-4">
              <a
                href="/login/doador"
                className="inline-block bg-white text-green-700 font-semibold py-2 px-4 rounded hover:bg-gray-200 transition"
              >
                Voltar para o Login
              </a>
            </div>
          ...
          <div className="text-center">
            <h2 className="text-xl font-bold">Cadastro concluído com sucesso!</h2>
            <a
              href="/login/doador"
              className="inline-block mt-4 bg-white text-green-700 font-semibold py-2 px-4 rounded hover:bg-gray-200 transition"
            >
              Ir para o Login
            </a>
          </div>
